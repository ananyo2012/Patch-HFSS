...
% 23 September 2012
% ----------------------------------------------------------------------------
function hfssInsertFarFieldSphereSetup_modified(fid, Name, Theta, Phi,WCS)
...
fprintf(fid, 'Set oModule = oDesign.GetModule("RadField")\n');
    ...
    fprintf(fid, 'oModule.EditFarFieldSphereSetup "Radiation", _\n');
...
% 
% Set oProject = oDesktop.SetActiveProject("vamsi")
% Set oDesign = oProject.SetActiveDesign("HFSSModell")
% Set oModule = oDesign.GetModule("RadField")
% oModule.InsertFarFieldSphereSetup Array("NAME:room", "UseCustomRadiationSurface:=",  _
%   false, "ThetaStart:=", "0deg", "ThetaStop:=", "0deg", "ThetaStep:=", "1deg", "PhiStart:=",  _
%   "0deg", "PhiStop:=", "0deg", "PhiStep:=", "1deg", "UseLocalCS:=", false)